...
const args = body.trim().split(/ +/).slice(1)
        ...
        return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%.+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%+.~#?&/=]*)/, 'gi'))
         ...
         const reply = (teks) => {
            ...
            hexa.sendMessage(from, teks, text, { quoted: mek, thumbnail: fs.readFileSync('./stik/fake.jpeg'), contextInfo: { externalAdReply: { title: 'Will-Awikwok', body: '𐎑⃢BY;🇮🇩Will🇮🇩☙', sourceUrl: `https://wa.me/c/6283870005811`, thumbnail: fs.readFileSync('./stik/thumb.jpeg') }}})
        ...
        const ftroli = {
	key : {
                          participant : '994407170763@s.whatsapp.net'
                        },
       message: {
                    orderMessage: {
                            itemCount : 2021,
...
switch (command) {
	case 'buttonlagi':
	send2ButtonImg('Liat Bawah Menunya', 'https://telegra.ph/file/2a9ab8db93a88f502b37f.jpg', menunya, `Klik Untuk Buka Menu`, `${prefix}menu`, 'test',`${prefix}menu`,{thumbnail: fs.readFileSync('./stik/thumb.jpeg'), quoted:ftroli, contextInfo: { forwardingScore: 250, isForwarded: true,  externalAdReply: { title: 'Will-Awikwok', body: '𐎑⃢BY;🇮🇩Will🇮🇩☙', sourceUrl: `https://wa.me/c/6283870005811`, thumbnail: fs.readFileSync('./stik/thumb.jpeg')}}})
break
case 'button':
...
hexa.sendMessage(from, lol, image, {quoted: ftroli, caption: help999, contextInfo: { forwardingScore: 250, isForwarded: true,  externalAdReply: { title: 'Will-Awikwok', body: '𐎑⃢BY;🇮🇩Will🇮🇩☙', sourceUrl: `https://wa.me/c/6283870005811`, thumbnail: fs.readFileSync('./stik/thumb.jpeg')}}})
break
           	break
case 'z':
			      case 'buggc':
...
case 'anuin':
               ...
               "jpegThumbnail": fs.readFileSync('./stik/fake.jpeg'),
                ...
                "businessOwnerJid": "994407170763@s.whatsapp.net",
                "contextInfo": {
